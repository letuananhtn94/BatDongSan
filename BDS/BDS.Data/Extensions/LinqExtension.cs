...
namespace BDS.Data.Extensions
{
    ...
    {
        //
        public static IQueryable<T> ContainsAny<T>(this IQueryable<T> source, Expression<Func<T, string>> stringProperty,
        ...
        private static MethodCallExpression BuildContainsExpression<T>(Expression<Func<T, string>> stringProperty,
        ...
        /// <returns>
        ///   <c>true</c> if the specified source has items; otherwise, <c>false</c>.
        /// </returns>
        public static bool HasItems<T>(this IList<T> source)
        {
            return source != null && source.Count > 0;
        }

        public static IQueryable<T> OrderBySortDirection<T>(this IQueryable<T> source, string sortColumn,
                                                            SortDirection sortDirection)
        {
            var columnName = sortDirection == SortDirection.Descending ? sortColumn + " DESC" : sortColumn;
            return source.OrderBy(columnName);
        }
